...
Стили модальных окон находятся в папке scss/vendor/micromodal.css
Так же для работы модальных окон, необходимо перейти в папку js/_functions.js и раскомментировать функцию вызова модальных окон MicroModal.init();
